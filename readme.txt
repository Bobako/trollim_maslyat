...
{
id,
urls(список ссылок  поста), (меня интересует не одна фотка в разном качестве, а все из поста. если она там одна - похуй, клади одну в массив, eсли видос - клади его)
caption(текст поста),
likes (число лайков),
